...
console.log('substr(3,6) :', string.substr(3,6), 'extrait une chaine de 6 caractère à partir de la 3eme position');
console.log('substring(3,6) :', string.substring(3,6), 'extrait la chaine comprise entre les positions 3 et 6');
